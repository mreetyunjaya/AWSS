module.exports = {
	...
	DEFAULT_PROJECT_PATH_TO_SCAN: "../online-shopping-system-master/", // `../` means one level up from the toolkit's folder, you can replace it with full path such as C:\\Users\\YourUsername\\Desktop\\ProjectToScan
